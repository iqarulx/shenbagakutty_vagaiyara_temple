...
$print_page = 1;
    ...
    $receipt_number_y = 45.5; $receipt_date_y = 44; $member_name_y = 57; $amount_y = 122; $amount_in_words_y = 90; $description_y = 78;
    if(!empty($receipt_y)) {
    ...
    $pdf->SetX(29);
    $pdf->Cell(165,5,$status_base_member_id." - ".$member_name,0,0,'C',1);
    ...
    $pdf->SetX(45);
    $pdf->Cell(105,5,$amount_in_words,0,0,'C',1);

    ...
    if(isset($json_obj->edit_id)) {
        ...
        if(empty($valid_receipt)) {
            ...
            if(empty($edit_id)) {
                ...
                $columns = array('created_date_time', 'creator', 'creator_name', 'receipt_id', 'receipt_type_id', 'receipt_number', 'receipt_date', 'member_id', 'member_name', 'status_base_member_id', 'amount', 'deleted');
                $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$null_value."'", "'".$receipt_type_id."'", "'".$null_value."'", "'".$receipt_date."'", "'".$member_id."'", "'".$member_name."'", "'".$status_base_member_id."'", "'".$amount."'", "'0'");

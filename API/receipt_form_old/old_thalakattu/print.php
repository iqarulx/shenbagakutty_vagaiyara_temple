...
$print_page = 1;
    ...
    $receipt_date = ""; $receipt_number = ""; $status_base_member_id = ""; $member_name = ""; $amount = ""; $description = ""; $form_name = "";
    ...
    $receipt_number_y = 46; $receipt_date_y = 45; $member_name_y = 68; $status_base_member_id_y = 121; $amount_y = 120; $amount_in_words_y = 93;
    $description_y = 80;
    if(!empty($receipt_y)) {
        ...
        $description_y = $description_y + $receipt_y;
    }
    ...
    $pdf->SetX(20);
    $pdf->Cell(90,5,$member_name,0,0,'C',1);

    $pdf->SetY($status_base_member_id_y);
    $pdf->SetX(100);
    $pdf->Cell(35,5,$status_base_member_id,0,0,'C',1);

    $pdf->SetY($amount_y);
    $pdf->SetX(20);
    $pdf->Cell(26,5,$amount."/-",0,0,'L',1);

    $pdf->SetY($amount_in_words_y);
    $pdf->SetX(25);
    $pdf->Cell(95,5,$amount_in_words,0,0,'C',1);

    $pdf->SetY($description_y);
    $pdf->SetX(45);
    $pdf->Cell(100,5,$description,0,0,'C',1);

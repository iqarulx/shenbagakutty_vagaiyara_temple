...
function populateStates(state) {	
	if(jQuery('form[name="company_form"]').find('select[name="country"]').length > 0) {
		var selectedCountryIndex = document.forms["company_form"]["country"].selectedIndex;
		var country = country_arr[selectedCountryIndex - 1];
		var selected_country = document.forms["company_form"]["country"].value;
		var stateElement = document.forms["company_form"]["state"];
	...
	if(jQuery('form[name="member_form"]').find('select[name="country"]').length > 0) {
		var selectedCountryIndex = document.forms["member_form"]["country"].selectedIndex;
		var country = country_arr[selectedCountryIndex - 1];
		var selected_country = document.forms["member_form"]["country"].value;
		var stateElement = document.forms["member_form"]["state"];
...
function populateCountries(country, state){
	if(jQuery('form[name="company_form"]').find('select[name="country"]').length > 0) {
		var countryElement = document.forms["company_form"]["country"];
	...
	if(jQuery('form[name="member_form"]').find('select[name="country"]').length > 0) {
		var countryElement = document.forms["member_form"]["country"];
		if( countryElement != null) {
			countryElement.length=0;
			countryElement.options[0] = new Option('Select Country','');
			countryElement.selectedIndex = 0;

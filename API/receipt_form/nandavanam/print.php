...
$print_page = 1;
    ...
    $receipt_date = ""; $receipt_number = ""; $member_unique_number = ""; $member_name = ""; $funeral_to = ""; $amount = ""; $form_name = "";
    ...
    if(!empty($view_receipt_id)) {
        ...
        if(!empty($view_receipt_list)) {
            foreach($view_receipt_list as $data) {
                ...
                if(!empty($data['member_unique_number']) && $data['member_unique_number'] != $GLOBALS['null_value']) {
    ...
    $receipt_number_y = 54.5; $receipt_date_y = 54; $member_name_y = 65; $funeral_to_y = 77; $amount_y = 94; $amount_in_words_y = 104.5;
    if(!empty($receipt_y)) {
    ...
    $pdf->SetX(60);
    $pdf->Cell(140,5,$member_name,0,0,'L',1);

    $pdf->SetY($funeral_to_y);
    $pdf->SetX(60);
    $pdf->Cell(140,5,$funeral_to,0,0,'L',1);
